...
public class secondminimum extends JFrame implements ActionListener {
    private JTextField num1Field, num2Field, num3Field;
    private JLabel resultLabel;

    public secondminimum() {
        ...
        JButton calculateBtn = new JButton("Find Second Minimum");
        ...
        setTitle("Second Min Number Finder");
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            ...
            if (num1 <= num2 && num1 <= num3) {
                secondLargest = Math.min(num2, num3);
            } else if (num2 <= num1 && num2 <= num3) {
                secondLargest = Math.min(num1, num3);
            } else {
                secondLargest = Math.min(num1, num2);
            }
            String result = String.format("The second minimum number is: %d", secondLargest);
